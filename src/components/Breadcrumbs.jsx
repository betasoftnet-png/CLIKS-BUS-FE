...
const Breadcrumbs = ({ items }) => {
    ...
    if (!breadcrumbs) {
        const pathnames = location.pathname.split('/').filter((x) => {
            ...
            return val && val !== 'business' && val !== 'dashboard' && val !== 'billing' && val !== 'books' && val !== 'home' && val !== 'crm' && val !== 'orders' && val !== 'accounting' && val !== 'expenses';
        });
    ...
    if (breadcrumbs) {
        breadcrumbs = breadcrumbs.filter(crumb => {
            ...
            return val !== 'business' && val !== 'dashboard' && val !== 'billing' && val !== 'books' && val !== 'home' && val !== 'crm' && val !== 'orders' && val !== 'accounting' && val !== 'expenses';
        });
    }
